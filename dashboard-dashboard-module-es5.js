...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["dashboard-dashboard-module"], {
    ...
    var AddemployeeComponent = /*#__PURE__*/function () {
      ...
      _createClass(AddemployeeComponent, [{
        ...
        value: function onSubmit(f) {
          ...
          this.service.saveEmployee(obj).subscribe(function (response) {
  ...
  function srcAppDashboardDashboardRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _service_auth_guard__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    /*! ../service/auth.guard */
    ...
    var routes = [{
      ...
      canActivate: [_service_auth_guard__WEBPACK_IMPORTED_MODULE_6__["AuthGuard"]]
    }, {
      path: "EmpDetails/:id",
  ...
  function srcAppDashboardDashboardModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _addemployee_addemployee_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
    /*! ../addemployee/addemployee.component */
    "./src/app/addemployee/addemployee.component.ts");
    /* harmony import */
  ...
  function srcAppEmployeedetailsEmployeedetailsComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var EmployeedetailsComponent = /*#__PURE__*/function () {
      function EmployeedetailsComponent(route, service, router) {
      ...
      _createClass(EmployeedetailsComponent, [{
        ...
        value: function onSubmit(f) {
          ...
          this.service.updateEmployee(this.empobj).subscribe(function (response) {
            // console.log(response)
  ...
  function srcAppHomeHomeComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _service_dialog_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
    ...
    var HomeComponent = /*#__PURE__*/function () {
      function HomeComponent(service, modalservice, dialogservice, toster) {
      ...
      _createClass(HomeComponent, [{
        ...
        value: function getDataFromBackend() {
          ...
          this.service.getAllEmployee().subscribe(function (response) {
            _this8.empdata = response;
            console.log(_this8.empdata);
          });
        }
      }, {
        key: "onUpdate",
        ...
        value: function onDelete() {
          ...
          if (this.isradioCheck) {
            this.dialogservice.OpenConfirmDialog('Are you sure to delete this record?').afterClosed().subscribe(function (res) {
              ...
              if (res) {
                _this9.service.DeleteRecord(_this9.empobj.id).subscribe(function (response) {
                  // console.log(response)
                  _this9.toster.success('Deleted Successfully!!! ');

                  _this9.getDataFromBackend();
                });
              }
            });
          } else {
          ...
          if (this.isradioCheck) {
            this.service.changeStatus(this.empobj).subscribe(function (response) {
              ...
              if (response == "update success") {
                _this10.toster.success('Status update successfully ');
              } else {
                _this10.toster.error('Employee is suspended can not change the status !!!');
              }

              _this10.getDataFromBackend();
            });
          } else {
  ...
  function srcAppUpdateEmployeeUpdateEmployeeComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var UpdateEmployeeComponent = /*#__PURE__*/function () {
      function UpdateEmployeeComponent(service, router) {
      ...
      _createClass(UpdateEmployeeComponent, [{
        ...
        value: function onUpdate() {
          ...
          this.service.updateEmployee(this.parentdata).subscribe(function (response) {
            // console.log(response)
            _this12.issubmitDissabled = false;
            _this12.backendResponse = response;
          });
        }
      }]);
