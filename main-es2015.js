...
/* harmony import */ var _new_registration_new_registration_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./new-registration/new-registration.component */ "./src/app/new-registration/new-registration.component.ts");
...
const routes = [
    ...
    {
        path: "newRegistration", component: _new_registration_new_registration_component__WEBPACK_IMPORTED_MODULE_4__["NewRegistrationComponent"]
    },
    {
...
/* harmony import */ var _new_registration_new_registration_component__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./new-registration/new-registration.component */ "./src/app/new-registration/new-registration.component.ts");
...
AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
        declarations: [
            ...
            _new_registration_new_registration_component__WEBPACK_IMPORTED_MODULE_15__["NewRegistrationComponent"]
        ],
        imports: [
...
let NewRegistrationComponent = class NewRegistrationComponent {
    ...
    onSubmit(f) {
        ...
        this.service.newRegistration(obj)
            .subscribe((response) => {
            // console.log(response)
...
NewRegistrationComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./new-registration.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/new-registration/new-registration.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./new-registration.component.css */ "./src/app/new-registration/new-registration.component.css")).default]
    })
...
let HttpService = class HttpService {
    ...
    saveEmployee(obj) {
        return (this.http.post(`${this.BaseUrl}saveEmployee`, obj));
    }
    newRegistration(obj) {
        return (this.http.post(`${this.BaseUrl}registerUser`, obj));
    }
    updateEmployee(obj) {
        return (this.http.put(`${this.BaseUrl}updateEmployee`, obj, { responseType: 'text' }));
    }
    DeleteRecord(id) {
        return (this.http.delete(`${this.BaseUrl}deleteEmpById/${id}`, { responseType: 'text' }));
    }
    changeStatus(obj) {
...
module.exports = __webpack_require__(/*! E:\JavaByKiran\On Job Training\OJT Angular\frontend\angular\angularproject\src\main.ts */"./src/main.ts");
